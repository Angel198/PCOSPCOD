...
public class CompletedPatientListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_patient_list);
    ...
    public void getdata()
    {
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                return requestHandler.sendPostRequest("http://curepcos.in/hospitalmanagement/api/total_Completed_patient", params);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.layout_re.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(CompletedPatientListActivity.this,CompletedpatientDetailActivity.class);
